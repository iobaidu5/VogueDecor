      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-[100000000000]">
          ...
          >
                          ...
                          >
                            <div className="relative flex w-full flex-row justify-between px-1 py-4">
                              ...
                              <div className="flex flex-row">
                                <div className="relative h-16 w-16 overflow-hidden rounded-md border border-neutral-300 bg-neutral-300 dark:border-neutral-700 dark:bg-neutral-100 dark:hover:bg-neutral-200">
                                  <Image
            ...
            {/* <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-white/80 p-6 text-black backdrop-blur-xl md:w-[390px] dark:border-neutral-700 dark:bg-black/80 dark:text-white z-50">
              <div className="flex items-center justify-between">
                <p className="text-lg font-semibold">My Cart</p>
                <button aria-label="Close cart" onClick={closeCart}>
                  <CloseCart />
